...
uint16_t pulses[] = {dshot_1, dshot_1, dshot_0, dshot_1, dshot_1, dshot_1, dshot_0, dshot_1, dshot_1,
                     dshot_1, dshot_1, dshot_0, dshot_0, dshot_1, dshot_1, dshot_0, 0};
uint16_t pulses2[] = {dshot_1, dshot_0, dshot_1, dshot_1, dshot_1, dshot_1, dshot_1, dshot_1,
                      dshot_1, dshot_1, dshot_1, dshot_0, dshot_1, dshot_1, dshot_0, 0};
...
#error
  ...
  dma1c2.init((uint32_t) & (timer.peripheral()->CCR1), (uint32_t)&pulses[0], sizeof(pulses) / 2, DMA_DIR_PeripheralDST,
