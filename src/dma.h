...
public:
  ...
  void init(uint32_t peripheralBaseAddr, uint32_t memoryBaseAddr, uint32_t bufferSize,
            ...
            uint32_t priority = DMA_Priority_Low, uint32_t memoryInc = DMA_MemoryInc_Disable,
            uint32_t peripheralInc = DMA_PeripheralInc_Disable, uint32_t m2m = DMA_M2M_Disable) {
