...
/******  STM32 specific Interrupt Numbers **********************************************************************/
  ...
  DMA1_Channel1_IRQn            = 9,      /*!< DMA channel 0 interrupt                                  */
  DMA1_Channel2_3_IRQn          = 10,     /*!< DMA channel 1 and channel 2 interrupts                   */
  DMA1_Channel4_5_IRQn          = 11,     /*!< DMA channel 3 and channel 4 interrupts                   */
  ADC_CMP_IRQn                 = 12,     /*!< ADC, CMP0 and CMP1 interrupts                            */
  TIM1_BRK_UP_TRG_COM_IRQn   = 13,     /*!< TIMER0 break, update, trigger and commutation interrupts */
  TIM1_CC_IRQn               = 14,     /*!< TIMER0 capture compare interrupt                         */
  TIM2_IRQn                  = 15,     /*!< TIMER1 interrupt                                         */
  TIM3_IRQn                  = 16,     /*!< TIMER2 interrupt                                         */
  TIM6_DAC_IRQn              = 17,     /*!< TIMER5 and DAC interrupts                                */
  TIM14_IRQn                 = 19,     /*!< TIMER13 interrupt                                        */
  TIM15_IRQn                 = 20,     /*!< TIMER14 interrupt                                        */
  TIM16_IRQn                 = 21,     /*!< TIMER15 interrupt                                        */
  TIM17_IRQn                 = 22,     /*!< TIMER16 interrupt                                        */
  I2C1_EV_IRQn                 = 23,     /*!< I2C0 event interrupt                                     */
  I2C2_EV_IRQn                 = 24,     /*!< I2C1 event interrupt                                     */
  SPI1_IRQn                    = 25,     /*!< SPI0 interrupt                                           */
  SPI2_IRQn                    = 26,     /*!< SPI1 interrupt                                           */
  USART1_IRQn                  = 27,     /*!< USART0 interrupt                                         */
  USART2_IRQn                  = 28,     /*!< USART1 interrupt                                         */
  CEC_IRQn                     = 30,     /*!< CEC interrupt                                            */
  I2C1_ER_IRQn                 = 32,     /*!< I2C0 error interrupt                                     */
  I2C2_ER_IRQn                 = 34,     /*!< I2C1 error interrupt                                     */
  I2C3_EV_IRQn                 = 35,     /*!< I2C2 event interrupt                                     */
  I2C3_ER_IRQn                 = 36,     /*!< I2C2 error interrupt                                     */
  DMA1_Channel6_7_IRQn          = 48,     /*!< DMA1 channel 5 and channel 6 interrupts                  */
  USBFS_WKUP_IRQn              = 42,     /*!< USBFS wakeup interrupt                                   */
  SPI3_IRQn                    = 51,     /*!< SPI2 global interrupt                                    */ 
