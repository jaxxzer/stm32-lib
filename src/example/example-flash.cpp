...
void initParameters(void) {
  ...
  writeParams(); // update boot count // TODO replace with param length? for endurance considerations and carryover
                 // after upgrade
}
...
void printParams(void) {
  print("\n\rboot count: ");
  my_printInt(params.boot_count);
  print(" last key pressed: ");
  _write(FD_STDOUT, (char *)&(params.last_key), 1);
}
